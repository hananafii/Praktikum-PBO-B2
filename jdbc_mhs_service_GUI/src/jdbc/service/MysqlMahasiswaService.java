...
public class MysqlMahasiswaService {
    ...
    /* Reset indeks tabel mahasiswa kembali ke 1 */
    public void indexReset() {
        // Query untuk mengembalikan nilai Auto Increment MySQL kembali ke 1
    ...
    public boolean isEmpty() {
        ...
        try (Statement s = koneksi.createStatement()) {
            ResultSet rs = s.executeQuery(query);
            if (rs.next()) {
                // Jika jumlah baris > 0, berarti tabel tidak kosong (false)
